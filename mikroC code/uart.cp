...
void showLCDtxt(int num, int n2)
{
 uint8_t txtN[6];
 uint8_t txtN2[6];
 IntToStr(num,txtN);
...
void USART2_Receive()
{
 ...
 showLCDtxt(current, receiveUART.bufferPointerWrite);
...
{
#line 160 "C:/Users/tasha/Desktop/UART receive debug/uart.c"
}


void sendSMS() {
#line 172 "C:/Users/tasha/Desktop/UART receive debug/uart.c"
}
...
uint8_t sendData(float temp, float hum, float pres, float dist) {
 ...
 my_Delay_ms( 3000 );
 if(checkReceiveTxt()==0) return 0;
#line 307 "C:/Users/tasha/Desktop/UART receive debug/uart.c"
 return 1;
}
